...
@Default
public class GeoJSONBuilderImpl implements GeoJSONBuilder {
	

	@Override
	public GeoJSONFeatureCollection decodeSimpleFeature(
			SimpleFeature feature) {
		
		List<SimpleFeature> features = new ArrayList<SimpleFeature>();
		features.add(feature);
		
		return this.decodeSimpleFeatureList(features);
	}
